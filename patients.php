...
if (isset($_POST['save_Patient'])) {
    ...
    $gender = $_POST['gender'];
if ($patientName != '' && $address != '' && $dateBirth != '' && $phoneNumber != '' && $gender != '') {
      $query = "INSERT INTO `patients`(`patient_name`, 
    `address`, `date_of_birth`, `phone_number`, `gender`)
VALUES('$patientName', '$address', '$dateBirth',
'$phoneNumber', '$gender');";
try {
...
$query = "SELECT `id`, `patient_name`, `address`, date_format(`date_of_birth`, '%d %b %Y') as `date_of_birth`, 
`phone_number`, `gender` 
